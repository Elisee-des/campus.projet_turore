            ...
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <div class="navbar-brand-box horizontal-logo">
                        <a href="{{ route('tableaudebord') }}" class="logo logo-dark">
                            <span class="logo-sm">
                        ...
                        <a href="{{ route('tableaudebord') }}" class="logo logo-light">
                            <span class="logo-sm">
                                <img src="assets/images/logo-sm.png" alt="" height="22">
                            </span>
                            <span class="logo-lg">
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="dropdown topbar-head-dropdown ms-1 header-item">
                        ...
                        <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                            ...
                            <span class="d-flex align-items-center">
                                ...
                                <span class="text-start ms-xl-2">
                                    <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{auth()->user()->nom_prenom}}</span>
                                    <span
                        ...
                        <div class="dropdown-menu dropdown-menu-end">
                            <!-- item-->
                            <h6 class="dropdown-header">Bienvenue {{auth()->user()->nom_prenom}}</h6>
                            <a class="dropdown-item" href="{{route('parametre-index')}}"><i
                                    class="mdi mdi-account-circle text-muted fs-16 align-middle me-1"></i> <span
                                    class="align-middle">Profil</span></a>
                                    @livewire('public.logout')
