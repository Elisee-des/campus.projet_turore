                                ...
                                <div class="p-2 mt-4">
                                    <form action="index.html">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="username" placeholder="Entrer votre email">
                                        </div>

                                        <div class="mb-3">
                                            <div class="float-end">
                                                <a href="#" class="text-muted">Mot de passe oublier?</a>
                                            </div>
                                            <label class="form-label" for="password-input">Mot de passe</label>
                                            <div class="position-relative auth-pass-inputgroup mb-3">
                                                <input type="password" class="form-control pe-5 password-input" placeholder="Entrer votre mot de passe" id="password-input">
